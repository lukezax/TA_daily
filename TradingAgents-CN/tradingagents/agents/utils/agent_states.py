...
class AgentState(MessagesState):
    ...
    # CZSC (缠论) analyst report
    czsc_report: Annotated[str, "Report from the CZSC (Chan Theory) Analyst"]
    czsc_signals: Annotated[str, "Structured CZSC signals as JSON string"]

    # Yangjia (养家) analyst report
    yangjia_report: Annotated[str, "Report from the Yangjia (养家) Analyst"]
