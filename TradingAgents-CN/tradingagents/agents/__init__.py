...
_EXPORTS: Dict[str, Tuple[str, str]] = {
    ...
    "create_czsc_analyst": ("tradingagents.agents.analysts.czsc_analyst", "create_czsc_analyst"),
    "create_yangjia_analyst": ("tradingagents.agents.analysts.yangjia_analyst", "create_yangjia_analyst"),
