...
def create_neutral_debator(llm):
    def neutral_node(state) -> dict:
        ...
        correct_name = state.get("company_of_interest", "未知")
        correct_price = "未知"
        ...
        correct_price = extract_price_with_fallback(state.get("company_of_interest", ""), market_research_report)
...
- 公司名称：{correct_name}
- 股票代码：{state.get("company_of_interest", "未知")}
- 当前价格：¥{correct_price}
