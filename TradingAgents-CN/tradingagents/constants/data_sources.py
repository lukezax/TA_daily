...
DATA_SOURCE_REGISTRY: Dict[str, DataSourceInfo] = {
    ...
    # 智兔 API
    DataSourceCode.ZHITU: DataSourceInfo(
        code=DataSourceCode.ZHITU,
        name="Zhitu",
        display_name="智兔 API",
        provider="智兔数据",
        description="智兔 API 提供A股实时行情、历史K线和股票列表数据",
        supported_markets=["a_shares"],
        requires_api_key=True,
        is_free=False,
        official_website="https://api.zhituapi.com",
        features=["实时行情", "历史K线", "股票列表", "高优先级"],
    ),
